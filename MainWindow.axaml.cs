...
public partial class MainWindow : Window
{
    ...
    private void EnterFullscreen()
    {
        ...
        var parent = VideoPlayer.Parent as Panel;
        parent?.Children.Remove(VideoPlayer);
        _fullscreenWindow.Content = VideoPlayer;
    ...
    private void ExitFullscreen()
    {
        ...
        {
            // Move video player back to main window
            _fullscreenWindow.Content = null;
            _fullscreenWindow.Close();
            _fullscreenWindow = null;

            // Find the video player container and add it back
            var border = this.FindControl<Border>("VideoPlayer")?.Parent as DockPanel;
            border?.Children.Add(VideoPlayer);
        }
    }
