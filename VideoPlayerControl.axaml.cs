...
public partial class VideoPlayerControl : UserControl
{
    ...
    public void InitializePlayer()
    {
        try
        {
            Console.WriteLine("InitializePlayer called");
            
            _playerService = new VideoPlayerService();
            _playerService.Initialize();

            Console.WriteLine("VideoPlayerService initialized");
            ...
            {
                Console.WriteLine($"ERROR: MediaPlayer={_playerService.MediaPlayer != null}, VideoHost={VideoHost != null}");
            }
    ...
    public void LoadVideo(string filePath)
    {
        try
        {
            Console.WriteLine($"LoadVideo called with: {filePath}");
            
            if (_playerService == null)
            {
                Console.WriteLine("Player service is null, initializing...");
                InitializePlayer();
            }

            if (_playerService == null)
            {
                Console.WriteLine("ERROR: Player service initialization failed!");
                return;
            }

            Console.WriteLine("Loading video (not auto-playing)...");
            ...
            Console.WriteLine("Video loaded successfully (paused)");
        }
        catch (Exception ex)
        {
